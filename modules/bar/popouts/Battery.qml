...
Column {
    ...
    StyledText {
        ...
        text: UPower.displayDevice.isLaptopBattery ? qsTr("时间 %1: %2").arg(UPower.onBattery ? "剩余" : "充满").arg(UPower.onBattery ? formatSeconds(UPower.displayDevice.timeToEmpty, "计算中...") : formatSeconds(UPower.displayDevice.timeToFull, "已充满！")) : qsTr("电源模式: %1").arg(PowerProfile.toString(PowerProfiles.profile))
    }
